...
![Muscle preservation strategy pyramid](/content/assets/diagrams/muscle-preservation-strategies.jpg)
...
:::case
A 58-year-old man on semaglutide 2.4mg for 4 months: lost 22 lbs, 41% lean mass. ALMI declined 7.4 → 6.8 kg/m². Grip strength down 3 kg. Skipping breakfast due to nausea. Eating primarily crackers on injection days. No exercise program. He asks: "Should I stop the medication?"

**Clinical Question:** Discontinuation is wrong. What are the three modifiable drivers — and how do you frame this conversation?
:::
...
### Requirements During Weight Loss

Protein needs increase during weight loss. The following targets reflect current evidence[^1][^2][^3]:

| Situation | Protein Target | Notes |
|-----------|----------------|-------|
| General health (no weight loss) | 0.8 g/kg body weight | RDA minimum; may be insufficient for older adults |
| Active weight loss (diet alone) | 1.2-1.6 g/kg body weight | Helps preserve lean mass during deficit |
| Active weight loss + resistance training | 1.6-2.2 g/kg body weight | Optimal for muscle preservation and growth stimulus |
| Older adults on GLP-1 therapy | 1.2-1.6 g/kg body weight minimum | Consider higher end given anabolic resistance |

:::note
For patients with significant obesity, protein targets based on adjusted body weight (halfway between actual and ideal body weight) may be more practical than total body weight calculations.
:::
...
For patients on GLP-1 therapy, the following protocol balances effectiveness with adherence:

| Component | Recommendation | Rationale |
|-----------|---------------|-----------|
| **Frequency** | 2-3 sessions per week | Sufficient stimulus without overwhelming patients new to exercise |
| **Exercise selection** | Compound movements (squat, deadlift, press, row) | Maximum muscle recruitment per exercise |
| **Sets and reps** | 2-3 sets of 8-12 repetitions | Hypertrophy range; manageable volume |
| **Progression** | Increase weight when 12 reps are achieved with good form | Progressive overload drives adaptation |
| **Rest periods** | 90-120 seconds between sets | Allows adequate recovery for quality sets |
| **Session duration** | 30-45 minutes | Realistic for adherence |
...
Treatment should aim for these targets:

| Metric | Target | Action if Not Met |
|--------|--------|-------------------|
| Lean mass loss proportion | <30% of total weight loss | Intensify protein and exercise |
| Grip strength | Stable or improving | Review exercise program |
| Functional measures | Maintained or improved | Consider PT referral |
| Fat loss | Continues to decrease | Continue current approach |
| VAT | Decreasing | Positive metabolic signal |
| ALM/height² | Above sarcopenia cutoffs | Urgent intervention if approaching thresholds |
...
Frame the conversation around optimization and investment protection:

- **"We want to make sure you're getting the most out of your medication."** This positions monitoring and lifestyle changes as enhancing their investment, not as additional burdens.
- **"Muscle is your metabolic engine—protecting it makes weight maintenance easier long-term."** This connects current actions to future outcomes patients care about.
- **"Protein and exercise aren't optional extras—they're how we make sure this weight loss improves your health for the long run."** This establishes non-negotiable expectations.
- **"Some muscle loss during significant weight loss is normal. Our job is to minimize it."** This sets realistic expectations and reduces anxiety.
...
Preserving muscle during GLP-1 therapy requires a proactive, multi-pronged approach centered on protein optimization and resistance training. These interventions should be initiated early—ideally before or concurrent with medication start—rather than reactively after concerning DEXA findings. Serial DEXA monitoring provides objective feedback on the effectiveness of these strategies and guides clinical decision-making. When protein and exercise alone are insufficient, dose adjustments and specialist referrals provide additional tools to optimize weight loss composition. The goal is not to limit weight loss but to ensure that lost weight comes primarily from fat, preserving the muscle mass that supports long-term metabolic health and functional independence.

:::takeaways
1. **Protein optimization and resistance training must begin concurrently with GLP-1 therapy — not after lean mass loss is identified.** Reactive prescription is less effective than preventive co-prescription from day one.
2. **Protein targets during GLP-1-assisted weight loss: 1.6–2.2 g/kg/day (adjusted body weight in obesity).** 25–40g leucine-rich protein per meal across 3–4 meals.
3. **Resistance training reduces lean mass loss by ≥ 50% vs diet alone.** This is the most impactful single modifiable factor. Frame it as mandatory, not optional.
4. **GLP-1 nausea timing creates predictable scheduling opportunities.** Nausea peaks 1–3 days post-injection. Schedule high-protein meals and training on non-injection days.
5. **Medication discontinuation is last resort; dose pacing preferred if weight loss > 1–1.5%/week.** Stopping can be reframed as dose adjustment, buying time to optimize protein and exercise.
6. **30% lean mass loss threshold → intensify. 40% over two periods → escalate.** These are clinical decision triggers, not passive observations.
7. **Functional testing (grip, chair stand, gait speed) must accompany every DEXA review.** DEXA without functional context is incomplete.
:::
...
[^3]: Deutz NE, Bauer JM, Barazzoni R, et al. "Protein intake and exercise for optimal muscle function with aging: recommendations from the ESPEN Expert Group." *Clin Nutr*. 2014;33(6):929-936. doi:10.1016/j.clnu.2014.04.007
