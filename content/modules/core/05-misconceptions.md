...
**Reality:** A pound is a pound. What people mean is that muscle is *denser* than fat—the same volume of muscle weighs more than the same volume of fat.

This is why two people at the same weight can look very different. The person with more muscle mass will typically appear leaner and take up less space.
...
### "I can spot-reduce fat"

**Reality:** You cannot choose where your body loses fat. Targeted exercises strengthen specific muscles but don't preferentially burn fat in that area.

Fat loss follows genetic patterns. Most people lose visceral fat first (which is good news for health), followed by pattern-dependent subcutaneous fat loss.
...
For most people, every 3-6 months is appropriate. This allows time for meaningful changes while providing accountability checkpoints.

**More frequent scanning (monthly)** may be appropriate for:
- Athletes in competition prep
- Medical monitoring situations
- Research studies

**Less frequent scanning (annually)** is fine for:
...
DEXA is more accurate than consumer methods. Most BIA scales and handheld devices systematically underestimate body fat. When people first get a DEXA scan, they're often surprised to find their actual body fat is 5-8% higher than their scale indicated.

### Can I compare results from different DEXA machines?

Different manufacturers and even different models can produce slightly different results. For tracking trends, it's best to use the same scanner. However, DEXA results from any calibrated machine are generally comparable and clinically meaningful.
...
### Can I scan while pregnant?

No. Although DEXA radiation is very low, BodySpec does not scan pregnant women as a precaution. Additionally, pregnancy dramatically changes body composition in ways that make scanning not clinically useful.
